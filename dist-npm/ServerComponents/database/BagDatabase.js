...
var BagDatabase = (function () {
    ...
    BagDatabase.prototype.searchGemeente = function (query, limit, callback) {
    ...
    BagDatabase.prototype.lookupBagBuurt = function (bounds, isArea, callback) {
        if (!bounds) {
            console.log('No valid bounds supplied');
            callback(null);
            return;
